...
function loadMediaPreview(event) {
    ...
    fileReader.onload = function (e) {
        ...
        if (file.type.startsWith('image/')) {
            ...
            videoPreview.controls = true; // You can add controls for play/pause
            videoPreview.style.maxWidth = '100%'; // Optional, to ensure it's responsive
...
function showStory(index) {
    ...
    if (story.type === 'image') {
        ...
        videoElement.onloadedmetadata = () => startProgressBar(videoElement.duration * 1000);
        videoElement.onended = () => nextStory();
    }
